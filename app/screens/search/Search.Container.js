...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getSearchDropDwonValues: () => dispatch(getSearchDropDwonValues()),
            getQuickSearchCorrespondenceRecordList: (referencenumber, subject, status, senderRidEntityList, recipientRidEntityList, correspondenceFromDate, correspondenceToDate, superSearch, entityId) => dispatch(getQuickSearchCorrespondenceRecordList(referencenumber, subject, status, senderRidEntityList, recipientRidEntityList, correspondenceFromDate, correspondenceToDate, superSearch, entityId)),
        ...
        getAdvanceSearchCorrespondenceRecordList: (referencenumber, subject, ridCorrCategory, ridContractlist, senderRidEntityList, recipientRidEntityList, 
            reviwer, approver, correspondenceFromDate, correspondenceToDate, replyrequiredbyFromdate, replyrequiredbyTodate, isreplyrequired, isconfidential, status, superSearch, entityId) => dispatch(getAdvanceSearchCorrespondenceRecordList(referencenumber, subject, ridCorrCategory, ridContractlist, senderRidEntityList, recipientRidEntityList,
