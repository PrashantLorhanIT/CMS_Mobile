...
const CorrespondenceInitiatePopup = (props) => {
...
, paddingTop:0}} >
                        ...
                        <View style={{marginTop:0, marginLeft:0, marginRight:0, width:'100%', height:70, flexDirection:'column',marginBottom:-10}}>
                                ...
                                <Text style={{marginLeft:25,justifyContent:'center',alignContent:'center',alignItems:'center',marginTop:15, fontSize:17,fontFamily:FONT_FAMILY_PT_BOLD,color:'#ffffff'}}>{t('InboxScreen:Initiate')}</Text>
                                </ImageBackground>
                                </View>
                                <View style={{paddingTop:0,backgroundColor:'white',marginBottom:50}}>
                                   <Text style={{fontSize:14,margin:5,marginLeft:15,marginBottom:0,fontFamily:FONT_FAMILY_PT_REGULAR}}>{t('InboxScreen:InitiateMessage')}?</Text>
...
export default CorrespondenceInitiatePopup;
