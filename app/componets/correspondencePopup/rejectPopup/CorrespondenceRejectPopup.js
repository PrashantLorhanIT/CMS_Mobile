...
const CorrespondenceRejectPopup = (props) => {
                ...
                .then(res => {
                  console.log('Correspondence Details Approve response inside');
                    ...
                    if (res.data.statusCode == "200") {
                      alertWithMessage("Reject sucessfully");
...
, paddingTop:0}} >
                    <View style={{marginTop:200,width:screenWidth-40, height:260,marginLeft:20, marginRight:20, borderRadius:10,backgroundColor:'white'}}>
                            ...
                            <Text style={{marginLeft:25,justifyContent:'center',alignContent:'center',alignItems:'center',marginTop:15, fontSize:17,fontFamily:FONT_FAMILY_PT_BOLD,color:'#ffffff'}}>{t('InboxScreen:Reject')}</Text>
                            </ImageBackground>
                            </View>
                            <View style={{paddingTop:0,backgroundColor:'white',marginBottom:60}}>
                               <Text style={{fontSize:14,margin:15,marginBottom:0,fontFamily:FONT_FAMILY_PT_REGULAR}}>{t('InboxScreen:RejectMessage')}?</Text>
                             ...
                             <View style={{marginTop:10, flexDirection:'row',justifyContent:'space-between'}}>
                                ...
                                <Text uppercase={false} style={{fontSize:14,fontFamily:FONT_FAMILY_PT_REGULAR}}>{t('InboxScreen:Reject')}</Text>
                                 </Button>
                            </View> 
                            </View>
         </Container>
...
, paddingTop:0}} >
                    <View style={{marginTop:200,width:screenWidth-40, height:260,marginLeft:20, marginRight:20, borderRadius:10,backgroundColor:'white'}}>
                            ...
                            <View style={{marginTop:0, marginLeft:0, marginRight:0, width:'100%', height:70, flexDirection:'column',marginBottom:-10}}>
                            <ImageBackground source={HeaderTilte} style={{width:'100%', height:50, borderTopRightRadius:10,borderTopLeftRadius:10, overflow: 'hidden'}} >
                            <Text style={{marginRight:25,justifyContent:'center',alignContent:'center',alignItems:'center',marginTop:15, fontSize:17,fontFamily:FONT_FAMILY_PT_BOLD,color:'#ffffff',textAlign:'right'}}>{t('InboxScreen:Reject')}</Text>
                            </ImageBackground>
                            </View>
                            <View style={{paddingTop:0,backgroundColor:'white',marginBottom:60}}>
                               <Text style={{fontSize:14,margin:15,marginBottom:0,fontFamily:FONT_FAMILY_PT_REGULAR,textAlign:'right'}}>{t('InboxScreen:RejectMessage')}?</Text>
                                 <View style={{margin:5,marginLeft:10,marginRight:10,height:30}}>
...
export default CorrespondenceRejectPopup;
