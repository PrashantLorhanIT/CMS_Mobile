      ...
      // return async (dispatch) => {
          try {
            const params = {
              ...
              axios.post(`${constants.webService.baseURL}${constants.webService.methods.common.rfiForward}`, params, axios.defaults.headers.Authorization = `Bearer ${token}`)
              .then(res => {
                 ...
                 <Container style={{width:'100%',height:'100%',backgroundColor: 'rgba(128,128, 128, 0.5)', paddingTop:0}} >
                      ...
                      <View style={{marginTop:0, marginLeft:0, marginRight:0, width:'100%', height:70, flexDirection:'column',marginBottom:-10}}>
                              ...
                              <View style={{paddingTop:0,backgroundColor:'white',marginBottom:50}}>
                                 ...
                                 <Card>
                                 <TouchableOpacity style={{flexDirection: 'row', justifyContent: 'space-evenly', alignContent: 'center',flexShrink:0 , paddingRight:5 ,height:60}} onPress={() => { setisUserModalVisible(true) }}>
                                     <View style={{flex:1, flexDirection:'row',justifyContent: 'space-evenly', flexShrink:0 , flexWrap: 'wrap',height:60}}>
                                     <Content>
                                       <List>
                                     {
               ...
               <ScrollView>
                   <Container style={{width:'100%',height:'100%',backgroundColor: 'rgba(128,128, 128, 0.5)', paddingTop:0}} >
                        ...
                        <View style={{marginTop:0, marginLeft:0, marginRight:0, width:'100%', height:70, flexDirection:'column',marginBottom:-10}}>
                                ...
                                <View style={{paddingTop:0,backgroundColor:'white',marginBottom:50}}>
                                   <Text style={{fontSize:14,margin:10,marginTop:0,marginBottom:0,marginLeft:25,fontFamily:FONT_FAMILY_PT_REGULAR,textAlign:'right'}}>{t('InboxScreen:Pleaseselectforward')}</Text>
                                   <View style={{margin:5,height:65,marginTop:0}}>
                                   <Card>
                                   <TouchableOpacity style={{flexDirection: 'row', justifyContent: 'space-evenly', alignContent: 'center',flexShrink:0 , paddingRight:5 ,height:60}} onPress={() => { setisUserModalVisible(true) }}>
                                   <Icon name="arrow-drop-down" type="MaterialIcons" style={{width:25,marginRight:25}}/>
                                     ...
                                     if (userMasterIds.find((id) => id === user.ridUsermaster)) {
                                       ...
                                       console.log(user);
                                      return (
                                        <Label style={{fontSize: 13,height:15,marginLeft:0,marginRight:15,fontFamily:FONT_FAMILY_PT_REGULAR,color:'black',textAlign:'right'}}>{`${user.firstname} ${user.lastname}`}</Label>  
                                        );
                                        }  else{
                                      return null
                                      }    
...
export default RFIForwardPopup;
