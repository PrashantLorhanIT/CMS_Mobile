...
const CorrespondenceDelegatePopup = (props) => {
      ...
      // return async (dispatch) => {
          try {
            const params = {
              ...
              axios.post(`${constants.webService.baseURL}${constants.webService.methods.common.correspondenceDelegate}`, params, axios.defaults.headers.Authorization = `Bearer ${token}`)
              .then(res => {
                console.log('Correspondence Details Delegate response inside');
                  ...
                  if (res.data.statusCode == "200") {
                    ...
                    alertWithMessage("Delegate created sucessfully");
...
export default CorrespondenceDelegatePopup;
